...
// Allows us to override a POST to make a PUT
...
app.post(
    ...
    catchAsync(async (req, res, next) => {
        ...
        const campgroundSchema = Joi.object({
            // Make sure our body includes campground object and within that,
            // all of the following keys and their respective constraints
